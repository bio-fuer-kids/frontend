...
export function QualitySection() {
  return (
    <section id="qualitaet" className="pt-30 pb-2 bg-bio-sand-beige">
      <Container className="flex flex-col items-center text-center">
        ...
        <div className="mt-25 w-full flex justify-center">
          {features.map((feature) => (
            <article
              key={feature.title}
              className={`flex flex-col w-105 h-125 justify-between rounded-[64px] border border-bio-dark bg-bio-white p-12 text-left transition-transform md:p-12 ${feature.rotation}`}
            >
              {/* Icon oben rechts */}
              ...
              <div className="mt-16">
                ...
                <p className="mt-4 leading-relaxed text-bio-dark md:text-sm">
                  {feature.description}
                </p>
              </div>
            </article>
